...
import six
from watcher_metering_drivers.wrappers.virt import inspector as virt_inspector
from watcher_metering_drivers.wrappers.virt import util
...
class LibvirtInspector(virt_inspector.Inspector):
    ...
    def _get_uri(self):
        return self.libvirt_uri or self.per_type_uris.get(self.libvirt_type,
                                                          'qemu:///system')
